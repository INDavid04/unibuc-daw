...
<body>
    ...
    <main>
        ...
        <ul>
            <li><a href="./register-spectator.php">Creaza cont de spectator (i.e. vezi evenimentele)</a></li>
            <li><a href="./register-organizer.php">Creaza cont de organizator (i.e. adauga evenimentele)</a></li>
        </ul>
    </main>
