...
<head>
    ...
    <title>IND | DAW Cont de spectator</title>
                    ...
                    if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])){ 
                        ...
                        if($verify_response->success){ 
                            try {
                                ...
                                /// Insereaza in tabelul spectator
                                $stmt = $pdo->prepare("insert into spectator (id_utilizator, telefon) values (?, ?)");
                                $stmt->execute([$id_utilizator, $telefon]);

                                $pdo->commit();

                                echo 'Contul de spectator a fost creat cu succes. <a href="./">De acum va puteti autentifica cu username si password setate</a>';
                            } catch (Exception $e) {
                                $pdo->rollBack();
                        ...
                        echo 'Nu s-a putut adauga contul de spectator intrucat nu s-a bifat reCAPTCHA. <a href="./register-spectator.php">Mai incercati inca o data</a>';
                    } 
                } 
            } 
        ?>
